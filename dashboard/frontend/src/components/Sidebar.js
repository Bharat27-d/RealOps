    ...
    <div className="sidebar">
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: '11px', color: '#9ca3af', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px', fontWeight: '600' }}>
            Logged in as
          </p>
          <p style={{ fontSize: '15px', fontWeight: '700', color: '#3b82f6', margin: 0 }}>
            {user?.username}
          </p>
        </div>
