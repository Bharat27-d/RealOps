      ...
      <main class="page-container">
        ...
        <div class="section-header reveal">
          <div class="status-pill">
            ...
            <span class="section-label-sm">DISPATCH & INQUIRIES</span>
          </div>
              ...
              <form id="contact-form" onsubmit="ContactPage.handleSubmit(event)">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 20px; margin-bottom: 20px;">
                  <div style="display: flex; flex-direction: column; gap: 6px;">
                    <label class="metric-label">Your Name</label>
                  ...
                  <div style="display: flex; flex-direction: column; gap: 6px;">
                    <label class="metric-label">Email Address (Optional)</label>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 20px; margin-bottom: 20px;">
                  <div style="display: flex; flex-direction: column; gap: 6px;">
                    <label class="metric-label">Discord Tag / ID</label>
                  ...
                  <div style="display: flex; flex-direction: column; gap: 6px;">
                    <label class="metric-label">Inquiry Type</label>
                ...
                <div style="display: flex; flex-direction: column; gap: 6px; margin-bottom: 24px;">
                  <label class="metric-label">Message Details</label>
        ...
        <section class="reveal">
          <div class="section-header" style="margin-bottom: 32px;">
            <div class="section-label" style="letter-spacing: 0.14em;">DIRECT CHANNELS</div>
          ...
          <div class="grid-3-sm">
            ...
            <div class="bento-card" style="padding: 28px; background: rgba(18, 16, 16, 0.7); border: 1px solid rgba(255, 255, 255, 0.07); border-radius: 20px; display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                ...
                <h3 class="card-title" style="font-size: 18px; margin: 0 0 8px;">Discord Dispatch</h3>
                <p class="card-body" style="font-size: 13px; margin: 0 0 16px;">
            ...
            <div class="bento-card" style="padding: 28px; background: rgba(18, 16, 16, 0.7); border: 1px solid rgba(255, 255, 255, 0.07); border-radius: 20px; display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                ...
                <h3 class="card-title" style="font-size: 18px; margin: 0 0 8px;">Operations Dashboard</h3>
                <p class="card-body" style="font-size: 13px; margin: 0 0 16px;">
